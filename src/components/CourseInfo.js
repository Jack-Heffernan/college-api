...
const CourseCard = (props) => {
    ...
    const handleDelete = (id) => {
        ...
        axios.delete(`${apiURL}/courses/${id}`, {headers: {"Authorization" : `Bearer ${token}`}})
        .then(response => {
		...
		<>
			<div className="card card-side bg-base-100 shadow-xl m-10">
				...
				<div className="card-body max-w-[450px]">
                    ...
                    <button
						className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded mx-auto block mt-4"
